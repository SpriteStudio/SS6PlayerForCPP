...
if(NOT SS6PCPP_USE_MSVC_CUSTOM_SETTINGS)
set(SS6PCPP_USE_MSVC_CUSTOM_SETTINGS FALSE)
endif()
message(STATUS "SS6PCPP_USE_MSVC_CUSTOM_SETTINGS: ${SS6PCPP_USE_MSVC_CUSTOM_SETTINGS}")

if(SS6PCPP_USE_MSVC_CUSTOM_SETTINGS)
